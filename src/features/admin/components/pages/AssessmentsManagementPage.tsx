    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-border/70">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[11px] font-mono uppercase tracking-wider text-chart-2 font-semibold bg-chart-2/15 px-2.5 py-0.5 rounded-full">
              FR20 &bull; Screening Engine &bull; Module 2
            </span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="px-3 py-1.5 rounded-xl border border-chart-2/20 bg-chart-2/10 text-chart-2 text-xs font-mono font-medium">
            Active Modules: <strong>{activeModules}</strong>
          </div>
          <div className="px-3 py-1.5 rounded-xl border border-emerald-500/20 bg-emerald-500/10 text-emerald-600 text-xs font-mono font-medium flex items-center gap-1.5">
            ...
            <span>5 Domains Configured</span>
          </div>
        </div>
      </div>
